 ...
 *
 *	$Header: /cvsroot/doommod/dmm/src/pdb.c,v 1.1.1.1 2005/10/20 21:36:28 paralizer Exp $
 *
 *
 *
...
/**
 *	@file pdb.c
 *	@brief	Wrapper for using the pdb shared object.
 */
...
void recache_pdb_lib() {
	...
	_pdb_funcs._pdb_load_fptr = pdb_dlsym(_pdb_obj, "pdb_load");
	_pdb_funcs._pdb_unload_fptr = pdb_dlsym(_pdb_obj, "pdb_unload");
	_pdb_funcs._pdb_load_fptr = pdb_dlsym(_pdb_obj, "pdb_load");
	_pdb_funcs._pdb_unload_fptr = pdb_dlsym(_pdb_obj, "pdb_unload");
	_pdb_funcs._pdb_enable_fptr = pdb_dlsym(_pdb_obj, "pdb_enable");
	_pdb_funcs._pdb_disable_fptr = pdb_dlsym(_pdb_obj, "pdb_disable");
	_pdb_funcs._pdb_is_set_fptr = pdb_dlsym(_pdb_obj, "pdb_is_set");
	_pdb_funcs._pdb_create_link_fptr = pdb_dlsym(_pdb_obj, "pdb_create_link");
	_pdb_funcs._pdb_query_node_fptr = pdb_dlsym(_pdb_obj, "pdb_query_node");
	_pdb_funcs._pdb_query_fptr = pdb_dlsym(_pdb_obj, "pdb_query");
	_pdb_funcs._pdb_set_fptr = pdb_dlsym(_pdb_obj, "pdb_set");
	_pdb_funcs._pdb_set_node_fptr = pdb_dlsym(_pdb_obj, "pdb_set_node");
	_pdb_funcs._pdb_del_fptr = pdb_dlsym(_pdb_obj, "pdb_del");
	_pdb_funcs._pdb_trace_fptr = pdb_dlsym(_pdb_obj, "pdb_trace");
	_pdb_funcs._pdb_set_write_interval_fptr =
		pdb_dlsym(_pdb_obj, "pdb_set_write_interval");
	_pdb_funcs._pdb_need_write_fptr = pdb_dlsym(_pdb_obj, "pdb_need_write");
	_pdb_funcs._pdb_write_fptr = pdb_dlsym(_pdb_obj, "pdb_write");
	_pdb_funcs._pdb_set_free_method_fptr =
		pdb_dlsym(_pdb_obj, "pdb_set_free_method");
	_pdb_funcs._pdb_count_children_fptr = pdb_dlsym(_pdb_obj, "pdb_count_children");

	_pdb_funcs._pdb_free_node_fptr = pdb_dlsym(_pdb_obj, "pdb_free_node");
	_pdb_funcs._pdb_create_tree_fptr = pdb_dlsym(_pdb_obj, "pdb_create_tree");
	_pdb_funcs._pdb_create_list_fptr = pdb_dlsym(_pdb_obj, "pdb_create_list");
	_pdb_funcs._pdb_create_hash_fptr = pdb_dlsym(_pdb_obj, "pdb_create_hash");
	_pdb_funcs._pdb_create_abstract_fptr = pdb_dlsym(_pdb_obj,
		"pdb_create_abstract");
	_pdb_funcs._pdb_set_int_fptr = pdb_dlsym(_pdb_obj, "pdb_set_int");
